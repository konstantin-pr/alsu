...
var mdf_ajax_lock = true;//remove twice ajax request on the same time
...
//***
 document.addEventListener("DOMContentLoaded", function () {
    ...
    mdf_init();
    //***
    jQuery('.mdf_button_shortcode').life('click', function () {
        //mdf_ajax_auto_recount
        if (jQuery(this).parents('form').hasClass('mdf_ajax_auto_recount')) {
            mdf_ajax_lock = false;
            mdf_ajax_data_recount(jQuery(this).parents('form').prop('id'), jQuery(this).parents('form').data('slug'), false);
            return false;
        }
...
function container_serch_panel(direct = false) {

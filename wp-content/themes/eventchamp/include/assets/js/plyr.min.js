...
(function(root, factory) {
    ...
    var fullscreen,
        ...
        defaults = {
            ...
            loadSprite: true,
            iconPrefix: 'plyr',
            iconUrl: '//cdn.plyr.io/2.0.18/plyr.svg',
            blankUrl: '//cdn.plyr.io/static/blank.mp4',
            clickToPlay: true,
            hideControls: true,
    ...
    // Related: //www.leanbackplyr.com/test/h5mt.html
    ...
    // //www.ssbbartgroup.com/blog/how-not-to-misuse-aria-states-properties-and-roles
    ...
    var _storage = {
        supported: (function() {
            ...
            // see: //github.com/sampotts/plyr/issues/131
            try {
                // Add test item
    ...
    function Plyr(media, config) {
        ...
        function _setupCaptions() {
            ...
            if (!plyr.captionExists) {
                ...
                // Firefox bug: //bugzilla.mozilla.org/show_bug.cgi?id=1033144
        ...
        function _setTitle(iframe) {
            ...
            // Set iframe title
            // //github.com/sampotts/plyr/issues/124
        ...
        function _setupStorage() {
            ...
            // Clean up old volume
            // //github.com/sampotts/plyr/issues/171
            ...
            if (!value) {
                ...
                // version of plyr. See: //github.com/sampotts/plyr/pull/313
        ...
        function _setupEmbed() {
            ...
            if (plyr.type === 'youtube') {
                ...
                _setAttributes(soundCloud, {
                    src: '//w.soundcloud.com/player/?url=//api.soundcloud.com/tracks/' + mediaId,
                    id: id,
                });
        ...
        function _youTubeReady(videoId, container) {
            ...
            plyr.embed = new window.YT.Player(container.id, {
                ...
                playerVars: {
                    ...
                    modestbranding: 1,
                    disablekb: 1,
                    origin: '*', // //code.google.com/p/gdata-issues/issues/detail?id=5788#c45
                },
                events: {
                    ...
                    onStateChange: function(event) {
                        ...
                        switch (event.data) {
                            ...
                            case 1:
                                ...
                                // //code.google.com/p/gdata-issues/issues/detail?id=8690
        ...
        function _vimeoReady(mediaId, container) {
            ...
            var src = '//player.vimeo.com/video/' + mediaId + '?' + params;
            ...
            plyr.embed.on('loaded', function() {
                ...
                // //github.com/sampotts/plyr/issues/317
            ...
            if (config.keyboardShorcuts.focused) {
                ...
                if (config.keyboardShorcuts.global) {
                    _on(window, 'keydown keyup', function(event) {
                        ...
                        // and any that accept key input //webaim.org/techniques/keyboard/
        ...
        // Cancel current network requests
        // See //github.com/sampotts/plyr/issues/174
        function _cancelRequests() {
            ...
            // Info: //stackoverflow.com/questions/32231579/how-to-properly-dispose-of-an-html5-video-and-close-socket-or-connection
    ...
    function supported(type) {
        ...
        switch (type) {
            ...
            // Issue raised //github.com/vimeo/player.js/issues/87
            case 'vimeo':
                basic = true;
                full = !isOldIE && !isIos;
                break;

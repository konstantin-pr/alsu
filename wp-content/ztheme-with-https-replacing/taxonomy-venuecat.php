<?php
/*
	* The template for displaying venue category
*/
get_header(); ?>
					...
					if ( have_posts() ) {
						echo '<div class="venue-list column-2">';
							while ( have_posts() ) : the_post();
								echo eventchamp_venue_list_style_1( $post_id = get_the_ID(), $image = "true", $category = "true", $date = "true", $location = "true", $excerpt = "true", $status = "true", $price = "true" );
							endwhile;
						echo '</div>';

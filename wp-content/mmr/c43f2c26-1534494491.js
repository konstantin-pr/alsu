...
var mdf_range_update=!1;var mdf_ajax_content_redraw_page=0;var mdf_ajax_lock=!0;try{var mdf_woo_catalog_order_by=mdf_default_order_by;var mdf_woo_catalog_order=mdf_default_order}catch(e){}
jQuery(function(){jQuery.fn.life=function(types,data,fn){jQuery(this.context).on(types,this.selector,data,fn);return this};mdf_init();jQuery('.mdf_button_shortcode').life('click',function(){if(jQuery(this).parents('form').hasClass('mdf_ajax_auto_recount')){mdf_ajax_lock=!1;mdf_ajax_data_recount(jQuery(this).parents('form').prop('id'),jQuery(this).parents('form').data('slug'),!1);return!1}
return!0})});function mdf_init(){if(!jQuery('#pn_html_buffer').length){jQuery('body').append('<div id="pn_html_buffer" class="mdf_info_popup" style="display: none;"></div>');jQuery('body').append('<div id="pn_html_buffer2" style="display: none;"></div>')}
...
jQuery('#'+form_id+' .mdf_reset_button').click(function(){submit_mode='reset';if(jQuery("#"+form_id).hasClass('mdf_ajax_content_redraw')){mdf_ajax_content_redraw_page=0;mdf_ajax_lock=!1;mdf_ajax_data_recount(form_id,slug,!0);return}
...
function mdf_ajax_data_recount(form_id,slug,simple_form_redraw){if(mdf_ajax_lock){return}
...
function container_serch_panel(direct=!1){if(!direct){}
var data={action:"mdf_search_panel",mdf_search_terms:jQuery(".hidden_page_mdf_for_ajax").val()};jQuery.post(ajaxurl,data,function(content){if(content){jQuery(".container_serch_panel").html(content);mdf_init_tepms_panel()}})}

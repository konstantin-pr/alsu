...
<table class="form-table">
    <tbody>
        ...
        <tr valign="top">
            <th scope="row" class="mdf_for_premium_label"><?php _e('Custom text for search results', 'meta-data-filter') ?> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)<br /></th>
            <td>
                <input type="text" class="widefat" placeholder="premium only"  disabled=""><br />
                <input type="hidden" name="shortcode_options[options][show_items_count_text]" value=""><br />
            </td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <input type="checkbox" class="mdf_shortcode_options" readonly="" /> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)<br />
            </td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top" style="display: none;">
            ...
            <td>
                ...
                <input type="checkbox" class="mdf_shortcode_options" checked />&nbsp;
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <input type="checkbox" class="mdf_shortcode_options" disabled="" /> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>) <br />
            </td>
        </tr>
        ...
        <tr valign="top">
            <th scope="row" class="mdf_for_premium_label"><?php _e('Filter button text', 'meta-data-filter') ?> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)<br /></th>
            <td>
                <input type="text" class="widefat" value="premium only" disabled=""><br />
                <input type="hidden" class="widefat" name="shortcode_options[options][filter_button_text]" value="">
            </td>
        </tr>
        <tr valign="top">

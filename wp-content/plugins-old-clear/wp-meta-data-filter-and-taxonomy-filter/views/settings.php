                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="regular-text" value="premium only" disabled="" />
                                <input type="hidden" value="0" name="meta_data_filter_settings[results_per_page]">
            ...
            <div id="tabs-2">
                ...
                <table class="form-table">
                    <tbody>
                       ...
                       <tr valign="top">
                            <th scope="row" class="mdf_for_premium_label"><label><?php _e("Loading text", 'meta-data-filter') ?></label> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)</th>
                            <td>
                                <input type="text" class="regular-text" value="premium only" disabled="" />
                                <input type="hidden" value="<?php echo @$data['loading_text'] ?>" name="meta_data_filter_settings[loading_text]">
...
//+++
                        ...
                        <tr valign="top">
                            <th scope="row" class="mdf_for_premium_label"><label><?php _e("Toggle open sign", 'meta-data-filter') ?></label> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)</th>
                            <td>
                                <input type="text" class="regular-text" value="+" disabled="">
                                <input type="hidden" value="+" name="meta_data_filter_settings[toggle_open_sign]">
                        ...
                        <tr valign="top">
                            <th scope="row" class="mdf_for_premium_label"><label><?php _e("Toggle close sign", 'meta-data-filter') ?></label> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)</th>
                            <td>
                                <input type="text" class="regular-text" value="-" disabled="">
                                <input type="hidden" value="-" name="meta_data_filter_settings[toggle_close_sign]">
    ...
    <?php if (MetaDataFilter::$is_free): ?>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="width: 100%">
                    <a href="http://wp-filter.com/a/buy" alt="Get the plugin" target="_blank"><img src="<?php echo self::get_application_uri() ?>images/mdtf_banner.jpg" /></a>&nbsp;
                </td>
            </tr>
        </table>
    <?php endif; ?>

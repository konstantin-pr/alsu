...
<p>
    ...
    <label class="mdf_for_premium_label" for=""><?php _e('Hide items where count of items is 0', 'meta-data-filter') ?> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>):</label>
</p>
...
<p class="mdf_taxonomies_options_show_count" <?php if( ! $instance['taxonomies_options_show_count'] ): ?>style="display: none;"<?php endif; ?>>
    <input type="checkbox"  value="false" disabled="" /> (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)
    <label for="" class="mdf_for_premium_label"><?php _e ('Hide terms where count of items is 0', 'meta-data-filter') ?>:</label>
</p>
...
?>
    <input type="checkbox" readonly="" name="<?php echo $widget->get_field_name('act_without_button'); ?>" value="false" />
    <label class="mdf_for_premium_label" for="<?php echo $widget->get_field_id('act_without_button'); ?>"><?php _e('Auto submit form', 'meta-data-filter') ?>:(<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)</label>
</p>
...
<p>
    <label for="" class="mdf_for_premium_label"><?php _e('Title for filter button', 'meta-data-filter') ?>: (<a href="https://wp-filter.com/difference-free-premium-versions-plugin/" target="_blank">premium</a>)</label>
    <input class="widefat" type="text" value="premium only" disabled="" />
    <input type="hidden" id="<?php echo $widget->get_field_id('title_for_filter_button'); ?>" name="<?php echo $widget->get_field_name('title_for_filter_button'); ?>" value="<?php echo $instance['title_for_filter_button']; ?>" />
</p>
<hr />

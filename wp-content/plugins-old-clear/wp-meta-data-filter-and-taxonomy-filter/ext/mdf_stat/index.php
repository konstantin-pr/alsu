                        ...
                        if (!is_null($this->pdo)) {
                          ...
                          ";
                            ...
                            foreach ($res as $row) {
                                ...
                                $stmt->bindParam(':type', urlencode($row['type']), PDO::PARAM_STR);
                                $stmt->bindParam(':filter_id', urlencode($row['filter_id']), PDO::PARAM_STR);
                                $stmt->bindParam(':key_id', urlencode($row['key_id']), PDO::PARAM_STR);

        ...
        <tr valign="top">
            ...
            <td>
                ...
                <?php if (MetaDataFilter::$is_free): ?>
                    <?php if ($is_expire): // free version?>
                        <p class="mdf_notice"> <?php _e("Sorry, the trial period of Statistic has expired.", 'meta-data-filter') ?></p>
                    <?php else: ?>
                        <p class="mdf_notice"> <?php _e(" This is a trial version of the statistics for a period of six months.", 'meta-data-filter') ?></p>
                    <?php endif; ?>
                <?php endif; ?>
                <br />
